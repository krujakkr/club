 ...
 */
$menu_items = [
    'students' => ['href' => 'admin.php',          'icon' => 'fa-tachometer-alt', 'label' => 'จัดการนักเรียน'],
    'clubs'    => ['href' => 'admin_clubs.php',     'icon' => 'fa-users',          'label' => 'จัดการชุมนุม'],
    'teachers' => ['href' => 'admin_teachers.php',  'icon' => 'fa-chalkboard-teacher', 'label' => 'จัดการครู'],
    'import'   => ['href' => 'admin_import.php',    'icon' => 'fa-file-import',    'label' => 'นำเข้าข้อมูล'],
    'reports'  => ['href' => 'admin_reports.php',   'icon' => 'fa-chart-bar',      'label' => 'รายงาน'],
    'settings' => ['href' => 'admin_settings.php',  'icon' => 'fa-cog',            'label' => 'ตั้งค่าระบบ'],
];
?>
