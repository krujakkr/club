    ...
    if (mysqli_num_rows($members_result) > 0) {
        ...
        while ($member = mysqli_fetch_assoc($members_result)) {
            ...
            if ($admin_logged_in) {
                ...
                echo '<button class="btn btn-danger btn-sm" onclick="removeMember(\'' . $sid . '\',' . $club_id . ',this)" title="ถอนการเลือกชุมนุม">';
                echo '<i class="fas fa-user-minus"></i></button>';
                echo '</td>';
            }
            echo '</tr>';
        }
