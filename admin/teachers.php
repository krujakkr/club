...
// รายการกลุ่มสาระการเรียนรู้มาตรฐาน 8 กลุ่ม
...
// ดึงรายการแผนกที่มีอยู่ในฐานข้อมูล (เผื่อมีค่าที่ไม่ได้อยู่ในรายการมาตรฐาน)
    ...
    <script>
        ...
        function deleteTeacher(teacherId, teacherName, clubCount) {
            ...
            if (confirm('คุณแน่ใจหรือไม่ที่จะลบข้อมูลครู "' + teacherName + '"?\nการกระทำนี้ไม่สามารถยกเลิกได้')) {
                window.location.href = 'teachers.php?delete=1&teacher_id=' + encodeURIComponent(teacherId);
            }
        }
